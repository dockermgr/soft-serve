...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210251747-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 25, 2022 17:47 EDT
# @@File             :  install.sh
# @@Description      :  
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/soft-serve"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="soft-serve"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/soft-serve"
APPDIR="$HOME/.local/share/srv/docker/soft-serve"
DATADIR="$HOME/.local/share/srv/docker/soft-serve/rootfs"
...
TZ=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default soft-serve
CONTAINER_HOSTNAME=""
